...
public class Will implements AttributeObserver {

    private AttributeData data;

    private Will(final Intelligence intelligence) {
        data = AttributeData.of(CharacterPoints.FIVE, intelligence.getLevel());
    }

    public static Will of(final Intelligence intelligence) {
        return new Will(intelligence);
    }
