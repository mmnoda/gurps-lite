...
public class BasicMove implements AttributeObserver {

    private AttributeData data;

    private BasicMove(final BasicSpeed basicSpeed) {
        data = AttributeData.of(CharacterPoints.TEN, basicSpeed.getLevelTruncated(), AttributeAbbreviate.BS);
    }

    public static BasicMove of(final BasicSpeed basicSpeed) {
        return new BasicMove(basicSpeed);
    }
