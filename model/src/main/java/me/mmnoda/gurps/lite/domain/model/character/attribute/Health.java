...
public class Health implements PrimaryAttribute, Comparable<Health>, Formattable {

    private AttributeData data;

    public static Health of() {
        return new Health().init();
    }

    private Health init() {
        data = AttributeData.of(CharacterPoints.TEN, AttributeLevel.TEN, AttributeAbbreviate.HT);
        return this;
    }
    ...
    public boolean addObserver(final FatiguePoints fatiguePoints) {
        return data.addObserver(fatiguePoints);
    }
