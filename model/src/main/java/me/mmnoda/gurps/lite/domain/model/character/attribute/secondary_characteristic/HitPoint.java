...
public class HitPoint implements AttributeObserver {

    private AttributeData data;

    private HitPoint(final Strength strength) {
        data = AttributeData.of(CharacterPoints.FIVE, strength.getLevel());
    }

    public static HitPoint of(final Strength strength) {
        return new HitPoint(strength);
    }

    @Override
    public void update(final AttributeData newData, final AttributeAbbreviate abbreviate) {
        checkArgument(abbreviate == AttributeAbbreviate.ST);
