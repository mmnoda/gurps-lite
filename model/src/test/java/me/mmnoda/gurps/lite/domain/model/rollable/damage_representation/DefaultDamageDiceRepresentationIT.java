...
public class DefaultDamageDiceRepresentationIT {
    ...
    private final Dice d6 =  Dices.D6.getInstance();
    ...
    public void should_format_cut_type_without_armor_divisor() {
        ...
        buildDefaultDamageDiceRepresentation(DamageType.CUT, ArmorDivisor.NONE);
        format();
    ...
    public void should_format_fatigue_type_with_armor_divisor_of_2() {
        ...
        buildDefaultDamageDiceRepresentation(DamageType.FATIGUE, ArmorDivisor._2);
        format();
    ...
    public void should_format_toxic_type_with_armor_divisor_of_3() {
        ...
        buildDefaultDamageDiceRepresentation(DamageType.TOXIC, ArmorDivisor._3);
        format();
    ...
    public void should_format_corrosive_type_with_armor_divisor_of_5() {
        ...
        buildDefaultDamageDiceRepresentation(DamageType.CORROSIVE, ArmorDivisor._5);
        format();
    ...
    public void should_format_impaling_type_with_armor_divisor_of_10() {
        ...
        buildDefaultDamageDiceRepresentation(DamageType.IMPALING, ArmorDivisor._10);
        format();
